...
class HAR():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'CMD':          {'learning_rate': 1e-2, 'src_cls_loss_wt': 0.96, 'domain_loss_wt': 5.52, 'cmd_moments': 4}
        }
...
class EEG():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'CMD':          {'learning_rate': 0.0005,   'src_cls_loss_wt': 0.960,   'domain_loss_wt': 5.523, 'cmd_moments': 4}
        }
...
class WISDM():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'CMD':          {'learning_rate': 1e-2,     'src_cls_loss_wt': 0.960,   'domain_loss_wt': 5.523,        'cmd_moments': 4}
        }
